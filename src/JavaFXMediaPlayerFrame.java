...
public class JavaFXMediaPlayerFrame extends javax.swing.JFrame {
    ...
    public JavaFXMediaPlayerFrame(String path) {
        ...
        fxPanel.setBounds(0, 0, w-50, h-100);
        add(fxPanel);
        setVisible(true);
    ...
    private void initFX(JFXPanel fxPanel) {
        ...
        final Media m = new Media("http://"+Credentials.ServerIP+":8888/StreamMedia/"+path);
        ...
        final Scene scene = new Scene(root, w-50, h-100);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              //  new JavaFXMediaPlayerFrame().setVisible(true);
            }
        });
    }
